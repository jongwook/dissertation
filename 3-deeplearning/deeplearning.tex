...
ALICE \cite{li2017alice} resolves the non-identifiability problem present in ALI that \TODO{state the drawbacks}, by adding a conditional entropy regularization term, and bidirectional conditional GAN (BCGAN) \cite{jaiswal2017bcgan} combines BiGAN with cGAN to perform both inference and conditional synthesis.
