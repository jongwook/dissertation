...
From a signal processing point of view, harmonic sounds are quasi-periodic and contain energy only at certain frequencies, typically at the multiples of the fundamental frequency, whereas percussive sounds have continuous frequency spectra in which it is not possible to define a fundamental frequency.
...
In theory, this can constitute a positive feedback loop where data augmentation improves the performance of the transcription model, and the improved synthesizer component of the transcription model provides better data augmentation. \TODO{revise}
...
This thesis considers the possibility of using deep generative models to learn the inductive bias \TODO{explain} incorporating musical concepts that are necessary for automatic music transcription.
...
\TODO{discuss more about the contributions}
